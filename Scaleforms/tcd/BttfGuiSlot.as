class BttfGuiSlot
{
	...
	function BttfGuiSlot(typeSlot, global, yOffset)
	{
		...
		this.monthMC.stop();
		this.monthMC._x = 76;
		this.monthMC._y = 82 + yOffset + 222;
		...
		this.minute1.stop();
		this.minute1._x = 1277;
		this.minute1._y = 84 + yOffset + 222;
		
		this.minute2 = this.globalMC.attachMovie(typeSlot + "Digit", typeSlot + "Minute2", this.globalMC.getNextHighestDepth());
		this.minute2.stop();
		this.minute2._x = 1277 + 78;
		this.minute2._y = 84 + yOffset + 222;
		
		this.amPm = this.globalMC.attachMovie(typeSlot + "AmPm", typeSlot + "AmPm", this.globalMC.getNextHighestDepth());
		this.amPm.stop();
		this.amPm._x = 0;
		this.amPm._y = 222;
	}
	...
	function setAmPm(amPmToggle)
	{
		amPm.gotoAndStop(amPmToggle);
	}
}