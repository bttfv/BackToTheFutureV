...
namespace BackToTheFutureV
{
    internal class TCDHandler : HandlerPrimitive
    {
        ...
        {
            if (FusionUtils.HideGUI || FusionUtils.PlayerVehicle != Vehicle || (GameplayCamera.FollowPedCameraViewMode == CameraViewMode.FirstPerson && Mods.IsDMC12) || TcdEditer.IsEditing || RCGUIEditer.IsEditing || Properties.IsRemoteControlled || MenuHandler.GarageMenu.Visible)
            {
                return;
            }
