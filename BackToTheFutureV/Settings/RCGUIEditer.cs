...
namespace BackToTheFutureV.Settings
{
    internal class RCGUIEditer
    {
        ...
        private static void AddButtons()
        {
            ...
            InstrumentalMenu.AddControl(Control.PhoneCancel, BTTFVMenu.GetLocalizedText("TCDEdit_Cancel"));
            InstrumentalMenu.AddControl(Control.PhoneSelect, BTTFVMenu.GetLocalizedText("TCDEdit_Save"));
        }
